...
\begin{document}
  ...
  \chapter{Introduction}
    ...
    \begin{figure}[h!] % FIXME cytowanie śmierdzi
	  ...
	  \caption{A molecule (blue) with a docked ligand(orange)~\ref{URL:docked}.}
	  \label{PIC:docked}
    \end{figure} 
  ...
  \igor{In this chapter the Convolutional Neural Network (CNN) model shall be described.}
     ...
     \begin{figure}[h!] % FIXME coś odnośniki nie działają
	  ...
	  \caption{An example of convolutional neural network~\ref{PIC:CONV_NET}.}
	...
	\begin{figure}[h!] %FIXME znów cytowanie śmierdzi
	  ...
	  \caption{An example of a whole neural network with stages of convolution and polling marked~\ref{URL:con_neur_INT}.}
