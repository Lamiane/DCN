...
\begin{document}
  ...
  \chapter{The Model or Deep Convolutional Neural Networks}
	...
	\subsubsection{Pooling} %TODO: zmienić poniższe notatki w tekst 
	  ...
	  The same problems might be encountered with pooling on the edges as with the convolutions. \\ %TODO: napisać ten akapit
