...
%  \mainmatter
  ...
  \chapter{The Model}\label{chap:OUR_MODEL}
   ...
   \section{Hyperopt}
	...
	\frame{\includegraphics[width=\linewidth]{MEAN_LAYERS_SCORE.pdf}}
	\caption{Score of the network and number of convolutional layers.}\label{Fig:MEAN_LAYERS_SCORE}
     ...
     \begin{figure}
      \begin{minipage}{\textwidth}
	\frame{\includegraphics[width=\linewidth]{MIN_LAYERS_SCORE.pdf}}
	\caption{Score of the network and number of convolutional layers.}\label{Fig:MIN_LAYERS_SCORE}
     ...
     \begin{figure}
      \begin {minipage}{\textwidth}
	\frame{\includegraphics[width=\linewidth]{SOFT_LAYERS_SCORE.pdf}}
